...
public class ChatAction<T> extends Action<T> {
    public static final String CHAT_INIT_THREAD = "chat/init_thread";
    public static final String CHAT_NEW_THREAD = "chat/new_thread";
    public static final String CHAT_CLICK_THREAD = "chat/click_thread";
    public static final String CHAT_INIT_MESSAGE = "chat/init_message";
